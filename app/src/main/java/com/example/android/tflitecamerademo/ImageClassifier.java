...
//    String floder =  Environment.getExternalStorageDirectory() + "/Download/inception_v3_android";
//    File file = new File(floder,getLabelPath());
//    FileInputStream is = new FileInputStream(file);

    InputStream is = activity.getAssets().open(getLabelPath());
...
//    String floder = Environment.getExternalStorageDirectory() + "/Download/inception_v3_android";
//    File file = new File(floder,getModelPath());
//    FileInputStream inputStream = new FileInputStream(file); // fileDescriptor.getFileDescriptor()
//    long startOffset = 0;
